...
export default function ProductDetails() {
    ...
    const increaseQuantity = () => {
        if (quantity < product.maxQuantity) {
            ...
            toast.show("Cannot add more", { type: "warning", placement: "top", duration: 1500 });
        }
    };
    const decreaseQuantity = () => {
        if (quantity > 1) {
            ...
            toast.show("Cannot decrease", { type: "warning", placement: "top", duration: 1500 });
        }
    };
    const addToCart = () => {
        const { id, title, heroImage, price, maxQuantity } = product;
        addItem({
            id,
            title,
            heroImage,
        ...
        <View style={styles.container}>
            ...
            <View style={{ padding: 16, flex: 1 }}>
                ...
                <View style={styles.buttonContainer}>
                    ...
                    <TouchableOpacity style={styles.addToCartButton} onPress={addToCart} disabled={quantity === 0}>
