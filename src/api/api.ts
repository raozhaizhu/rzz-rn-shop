    ...
    return useQuery({
        ...
        queryFn: async () => {
            ...
            if (categoryError || !category) {
                throw new Error("An error occurred while fetching data:" + categoryError?.message);
            }
            ...
            if (productsError || !products) {
                throw new Error("An error occurred while fetching data:" + productsError?.message);
            }
...
export const getMyOrder = (slug: string) => {
    ...
    return useQuery({
        ...
        queryFn: async () => {
            ...
            if (error || !data) throw new Error("An error occurred while fetching data: " + error.message);
