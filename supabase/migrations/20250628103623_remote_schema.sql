...
CREATE POLICY "Enable Delete for Admins" ON "public"."category" FOR DELETE USING ((( SELECT "users"."type"
   FROM "public"."users"
  WHERE ("users"."id" = "auth"."uid"())) = 'ADMIN'::"text"));



CREATE POLICY "Enable Insert for Admins" ON "public"."category" FOR INSERT TO "authenticated" WITH CHECK ((( SELECT "users"."type"
   FROM "public"."users"
  WHERE ("users"."id" = "auth"."uid"())) = 'ADMIN'::"text"));



CREATE POLICY "Enable Read for All" ON "public"."category" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "Enable Update for Admins" ON "public"."category" FOR UPDATE TO "authenticated" USING ((( SELECT "users"."type"
   FROM "public"."users"
...
CREATE POLICY "Enable insert for Admins" ON "public"."product" FOR INSERT TO "authenticated" WITH CHECK ((( SELECT "users"."type"
   FROM "public"."users"
  WHERE ("users"."id" = "auth"."uid"())) = 'ADMIN'::"text"));
...
CREATE POLICY "Enable read for All" ON "public"."users" FOR SELECT TO "authenticated" USING (true);
